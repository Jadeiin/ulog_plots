...
legendSize = 16;    % 图例字号
figureWidth = 1280;  % 图像宽度
figureHeight = 480;  % 图像高度

% X轴位置
figure(1);
set(gcf, 'Position', [100, 100, figureWidth, figureHeight], 'Color', 'white');
plot(local_position.timestamp*1e-6, local_position.x, 'b-', ...
    local_position_setpoint.timestamp*1e-6, local_position_setpoint.x, 'r--', 'LineWidth', 1);
grid on;
...
figure(2);
set(gcf, 'Position', [100, 100, figureWidth, figureHeight], 'Color', 'white');
plot(local_position.timestamp*1e-6, local_position.y, 'b-', ...
    local_position_setpoint.timestamp*1e-6, local_position_setpoint.y, 'r--', 'LineWidth', 1);
grid on;
...
figure(3);
set(gcf, 'Position', [100, 100, figureWidth, figureHeight], 'Color', 'white');
plot(local_position.timestamp*1e-6, local_position.z, 'b-', ...
    local_position_setpoint.timestamp*1e-6, local_position_setpoint.z, 'r--', 'LineWidth', 1);
grid on;
...
figure(4);
set(gcf, 'Position', [100, 100, figureWidth, figureHeight], 'Color', 'white');
plot(attitude.timestamp*1e-6, rad2deg(attitude.roll_body), 'b-', ...
    attitude_setpoint.timestamp*1e-6, rad2deg(attitude_setpoint.roll_body), 'r--', 'LineWidth', 1);
grid on;
...
figure(5);
set(gcf, 'Position', [100, 100, figureWidth, figureHeight], 'Color', 'white');
plot(attitude.timestamp*1e-6, rad2deg(attitude.pitch_body), 'b-', ...
    attitude_setpoint.timestamp*1e-6, rad2deg(attitude_setpoint.pitch_body), 'r--', 'LineWidth', 1);
grid on;
...
figure(6);
set(gcf, 'Position', [100, 100, figureWidth, figureHeight], 'Color', 'white');
plot(attitude.timestamp*1e-6, rad2deg(attitude.yaw_body), 'b-', ...
    attitude_setpoint.timestamp*1e-6, rad2deg(attitude_setpoint.yaw_body), 'r--', 'LineWidth', 1);
grid on;
...
figure(7);
set(gcf, 'Position', [100, 100, figureWidth, figureHeight], 'Color', 'white');
plot(angular_velocity.timestamp*1e-6, rad2deg(angular_velocity.xyz_0), 'b-', ...
    rates_setpoint.timestamp*1e-6, rad2deg(rates_setpoint.roll), 'r--', 'LineWidth', 1);
grid on;
...
figure(8);
set(gcf, 'Position', [100, 100, figureWidth, figureHeight], 'Color', 'white');
plot(angular_velocity.timestamp*1e-6, rad2deg(angular_velocity.xyz_1), 'b-', ...
    rates_setpoint.timestamp*1e-6, rad2deg(rates_setpoint.pitch), 'r--', 'LineWidth', 1);
grid on;
...
figure(9);
set(gcf, 'Position', [100, 100, figureWidth, figureHeight], 'Color', 'white');
plot(angular_velocity.timestamp*1e-6, rad2deg(angular_velocity.xyz_2), 'b-', ...
    rates_setpoint.timestamp*1e-6, rad2deg(rates_setpoint.yaw), 'r--', 'LineWidth', 1);
grid on;
...
figure(11);
set(gcf, 'Position', [100, 100, figureWidth, figureHeight], 'Color', 'white');
plot(actuator_outputs.timestamp*1e-6, actuator_outputs.output_0, 'b-', ...
    actuator_outputs.timestamp*1e-6, actuator_outputs.output_1, 'r--', ...
    actuator_outputs.timestamp*1e-6, actuator_outputs.output_2, 'g--', ...
    actuator_outputs.timestamp*1e-6, actuator_outputs.output_3, 'm--', 'LineWidth', 1);
grid on;
...
figure(13);
set(gcf, 'Position', [100, 100, figureWidth, figureHeight], 'Color', 'white');
plot(local_position.timestamp*1e-6, local_position.vx, 'b-', ...
local_position_setpoint.timestamp*1e-6, local_position_setpoint.vx, 'r--', 'LineWidth', 1);
grid on;
...
figure(14);
set(gcf, 'Position', [100, 100, figureWidth, figureHeight], 'Color', 'white');
plot(local_position.timestamp*1e-6, local_position.vy, 'b-', ...
    local_position_setpoint.timestamp*1e-6, local_position_setpoint.vy, 'r--', 'LineWidth', 1);
grid on;
...
figure(15);
set(gcf, 'Position', [100, 100, figureWidth, figureHeight], 'Color', 'white');
plot(local_position.timestamp*1e-6, local_position.vz, 'b-', ...
    local_position_setpoint.timestamp*1e-6, local_position_setpoint.vz, 'r--', 'LineWidth', 1);
grid on;
...
figure(16);
set(gcf, 'Position', [100, 100, figureWidth, figureHeight], 'Color', 'white');
plot(acceleration.timestamp*1e-6, acceleration.xyz_0, 'b-', 'LineWidth', 1);
grid on;
...
figure(17);
set(gcf, 'Position', [100, 100, figureWidth, figureHeight], 'Color', 'white');
plot(acceleration.timestamp*1e-6, acceleration.xyz_1, 'b-', 'LineWidth', 1);
grid on;
...
figure(18);
set(gcf, 'Position', [100, 100, figureWidth, figureHeight], 'Color', 'white');
plot(acceleration.timestamp*1e-6, acceleration.xyz_2, 'b-', 'LineWidth', 1);
grid on;
